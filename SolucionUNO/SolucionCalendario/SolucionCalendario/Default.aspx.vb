    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not galleta Is Nothing Then
            ...
            For i = 0 To arr.Count - 1
                ...
                Try
                    If val(0) = "cok_NombreUsuario" Then
                        vUsuario.Nom_Usua = val(1)
                    ElseIf val(0) = "cok_usuario" Then
                        vUsuario.usuario = val(1)
                        Session("Cod_USU") = val(1)
                    ElseIf val(0) = "cok_USU_ID" Then
                        vUsuario.Cod_Usua = val(1)
                        Session("ID_USER") = val(1)
                    ElseIf val(0) = "cok_CP" Then
                        Try
                        ...
                        Catch ex As Exception
                            vUsuario.Cod_Prov = 0
                        End Try
                    ElseIf val(0) = "cok_CP_NOMBRE" Then
                        Try
                            vUsuario.Nom_Prov = val(1)
                        Catch ex As Exception
                            vUsuario.Nom_Prov = ""
                        End Try
                    ElseIf val(0) = "cok_ROL_IPRESS_CODIGO_CBR" Then

                        Select Case val(1)
                            Case 303
                                vUsuario.rol = "USUARIO"
                            Case 304
                                vUsuario.rol = "GERENTE"
                            Case 305
                                vUsuario.rol = "SUPERVISOR"
                        End Select

                        vUsuario.Cod_Perf = val(1)
                    ElseIf val(0) = "cok_ROL_IPRESS_DESCRIPCION_CBR" Then
                        vUsuario.Nom_Perf = val(1)
                    ElseIf val(0) = "cok_EMAIL" Then
                        vUsuario.Cor_Elec = val(1)
                    ElseIf val(0) = "cok_ODSIS" Then
                        vUsuario.Cod_UDR = val(1)
                        Session("UDR_USER") = val(1)
                    ElseIf val(0) = "cok_ODSIS_NOMBRE" Then
                        vUsuario.Nom_UDR = val(1)
                    ElseIf val(0) = "cok_Dni" Then
                        dni = val(1)
                    End If
                Catch ex As Exception
                    Dim msnErr As String = ""
                    If val(0) = "cok_NombreUsuario" Or val(0) = "cok_USU_ID" Then
                        msnErr = "Usuario NO es válido.\n\nPor favor contacte con el administrador del Sistema."
                    ElseIf val(0) = "cok_CP_NOMBRE" Or val(0) = "cok_CP" Then
                        msnErr = "Proveedor NO es válido.\n\nPor favor contacte con el administrador del Sistema."
                    ElseIf val(0) = "cok_ROL_IPRESS_CODIGO_CBR" Or val(0) = "cok_ROL_IPRESS_DESCRIPCION_CBR" Then
                        msnErr = "Perfil de Usuario NO es válido.\n\nPor favor contacte con el administrador del Sistema."
                    ElseIf val(0) = "cok_EMAIL" Then
                        msnErr = "Cuenta de correo NO es válido.\n\nPor favor contacte con el administrador del Sistema."
                    ElseIf val(0) = "cok_ODSIS" Or val(0) = "cok_ODSIS_NOMBRE" Then
