...
(function($) {
	...
	Calendar.prototype._loadEvents = function() {
	    var self = this;
	    var date1 = new Date(self.options.position.start);
	    var n = date1.format('dd-M-yyyy').toString();
	    var date = new Date(self.options.position.start); 
	    var source = null;
			...
			case 'string':
				if(source.length) {
				    loader = function() {
				        ...
				        var params = "{ from: '" + self.options.position.start.format('dd-M-yyyy') + "', to2:  '" + self.options.position.end.format('dd-M-yyyy') + "' }";
					    ...
					    $.ajax({
					        ...
					        dataType: "json",
					        //data: params,
					        //url: 'CalendarioIndex.aspx/ObtenerEventos2', //buildEventsUrl(source, params),
