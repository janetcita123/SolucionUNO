Public Class SiteMaster
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not Usuario_Valido() Then
            Session.Abandon()
            Response.Redirect("../SisMenu/frmLogin.aspx")
            Exit Sub
        End If
        Dim vUsuario As Usuario
        vUsuario = Session("UsuarioIPRESS")
        lblNomUsuario.Text = "BIENVENIDO : " & UCase(vUsuario.Nom_Usua)
        lblNomPerfil.Text = vUsuario.Nom_Perf.ToUpper
        lblNomProv.Text = vUsuario.Nom_Prov

    End Sub
 
    

    Function Usuario_Valido() As Boolean
        Dim vUsuario As Usuario
